...
MIN_PATIENCE = 9998  # Min. customer patience set high to prevent people from leaving
...
def create_graph():
    ...
    plt.plot(x, y) # plots average line
    ...
    plt.fill_between(x, (lower_bound), (upper_bound), color='blue', alpha=0.1)

    plt.title('M/M/1 FIFO mean waiting time versus the system load')
    plt.xlabel('rho')
