...
def create_graph():
    ...
    #request_range = [num/100 for num in range(300) if num>=90] #create range 0.9 to range of interval of visits
    ...
    for cap in cap_list:
        ...
        for request_amount in request_range:
            ...
            for _ in range(sample_size):
                ...
                #mean_arrival = 1/request_amount   #could be set for a calcultion
